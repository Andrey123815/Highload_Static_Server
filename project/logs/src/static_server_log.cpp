...
StaticServerLog::StaticServerLog(std::string file, bool flush_flag, bl::trivial::severity_level lvl) : tag_(file), key_flush(flush_flag), log_level(lvl) {
...
void StaticServerLog::log(const std::string& s, bl::trivial::severity_level level_message) {
